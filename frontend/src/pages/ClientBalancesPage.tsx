  ...
  return (
    <div className="p-4 md:p-6 space-y-4 animate-fade-in">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Outstanding and advance balances per client</p>
      </div>
                    ...
                    <TableRow key={balance.clientName}>
                      ...
                      <TableCell className="text-right">
                        {balance.outstanding > 0 ? (
                          <span className="text-destructive font-semibold">{formatCurrency(balance.outstanding)}</span>
                        ) : (
                      ...
                      <TableCell className="text-right">
                        {balance.advance > 0 ? (
                          <span className="text-green-600 font-semibold">{formatCurrency(balance.advance)}</span>
                        ) : (
                          <span className="text-muted-foreground">—</span>
                        )}
                      </TableCell>
