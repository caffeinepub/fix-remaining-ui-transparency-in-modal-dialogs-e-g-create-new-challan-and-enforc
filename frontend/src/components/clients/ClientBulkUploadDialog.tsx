...
export function ClientBulkUploadDialog({ open, onClose, existingClients }: ClientBulkUploadDialogProps) {
      ...
      <DialogContent className="bg-background opacity-100 sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {preview.length > 0 && !uploadDone && (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">{preview.length} clients ready to upload</p>
