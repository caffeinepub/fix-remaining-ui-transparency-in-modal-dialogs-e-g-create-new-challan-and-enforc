...
export function PettyCashBulkUploadDialog({ open, onClose, existingRecords }: PettyCashBulkUploadDialogProps) {
      ...
      <DialogContent className="bg-background opacity-100 sm:max-w-2xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4">
          ...
          {previewCount > 0 && !uploadDone && (
            <p className="text-sm text-muted-foreground">{previewCount} records ready to upload</p>
          )}
          ...
          {!uploadDone ? (
            <>
              ...
              <Button
                ...
                disabled={isUploading || parsedRecords.length === 0 || !isActorReady || !isAuthenticated}
              >
                {isUploading ? (
                  <>
