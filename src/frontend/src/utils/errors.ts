...
export function classifyError(error: unknown): ClassifiedError {
  ...
  if (
    ...
    return {
      ...
      message:
        "Unable to establish initial connection to the backend. The health check probe failed.",
      originalError: error,
      troubleshooting: [
  ...
  if (
    ...
    return {
      category: "connection",
      message:
        "Unable to connect to the backend. The canister may be unreachable or not deployed.",
      originalError: error,
      troubleshooting: [
  ...
  if (
    ...
    return {
      category: "timeout",
      message:
        "The operation is taking longer than expected. The backend may be slow to respond or initializing.",
      originalError: error,
      troubleshooting: [
  ...
  if (
    ...
    return {
      ...
      message:
        "Backend canister not found. The canister may not be deployed or the canister ID is incorrect.",
      originalError: error,
      troubleshooting: [
  ...
  if (
    ...
    message.includes("actor is not ready")
  ) {
    return {
...
export function getUserFriendlyError(
  ...
  return (
    classified.message || fallback || "An error occurred. Please try again."
  );
}
