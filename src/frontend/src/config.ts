...
// HARDCODED: This is the live data canister. Never change without user confirmation.
const HARDCODED_CANISTER_ID = "fta74-uj2bo-de7nm-tugfh-6wwtx-4jqmx-2lmb6-ctii2-sbjei-urnag-dqe";
...
export async function loadConfig(): Promise<Config> {
  ...
  try {
    ...
    const fullConfig = {
      ...
      // Always use hardcoded canister ID for stability
      backend_canister_id: HARDCODED_CANISTER_ID,
    ...
    // Fallback config with hardcoded canister ID
