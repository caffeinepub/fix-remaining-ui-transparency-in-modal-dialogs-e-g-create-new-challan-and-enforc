...
export default function ChallanBulkUploadDialog({
  open,
  onClose,
  existingChallans,
}: ChallanBulkUploadDialogProps) {
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-blue-50 border border-blue-200 p-4 space-y-2">
                  ...
                  <p className="text-xs text-blue-800">
                    Challan ID, Client Name, Venue, Item Name, Quantity, Rate, Rental Days, Freight, Number of Days, Start Date, End Date, Site
                  </p>
                  <p className="text-xs text-blue-800 mt-2">
                    This will create new challans in bulk. Duplicate challan IDs will be rejected.
                  </p>
                </div>
